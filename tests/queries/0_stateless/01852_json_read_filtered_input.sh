...
$CLICKHOUSE_CLIENT -q "DROP TABLE IF EXISTS json_read_filtered_nested"
$CLICKHOUSE_CLIENT -q "CREATE TABLE json_read_filtered_nested (d1 UInt8, d2 String) ENGINE = Memory"
...
| $CLICKHOUSE_CLIENT --input_format_skip_unknown_fields=1 -q "INSERT INTO json_read_filtered_nested FORMAT JSONReadFiltered"

$CLICKHOUSE_CLIENT --max_threads=1 -q "SELECT * FROM json_read_filtered_nested"
